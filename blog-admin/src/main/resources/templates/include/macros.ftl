<#-- 公共顶部 -->
<#macro header title="" keywords="" description="" canonical="">
    <head>
        <meta charset="utf-8">
    ...
    <nav class="navbar navbar-expand-lg">
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between">
            ...
            <div class="right-menu list-inline no-margin-bottom">
                ...
                <!-- Log out               -->
                <div class="list-inline-item logout"><a id="logout" href="/login" class="nav-link"> <span
    ...
    <footer class="footer">
        <div class="footer__block block no-margin-bottom">
            <div class="container-fluid text-center">
                <p class="no-margin-bottom">Copyright &copy; 2019.Personal minggui All rights reserved.More Templates</p>
            </div>
        </div>
    </footer>
</#macro>
